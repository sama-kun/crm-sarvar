...
export class Initail1711060840083 implements MigrationInterface {
    name = 'Initail1711060840083'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "amount" double precision, "paymentType" "public"."order_paymenttype_enum" NOT NULL DEFAULT 'debt', "updatedById" integer, "createdById" integer, "ownerId" integer, "deliverymanId" integer, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "paymentHistory" ADD CONSTRAINT "FK_b29b7051df2cfb18a0a21a3861b" FOREIGN KEY ("orderId") REFERENCES "order"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "paymentHistory" ADD CONSTRAINT "FK_ad9fa7a03c15570078c98829987" FOREIGN KEY ("profileId") REFERENCES "profile"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
